...
return [
    ...
    */
    ...
    'models' => [
        'role'          => env('ROLES_DEFAULT_ROLE_MODEL', \App\Models\Role::class), // jeremykenedy\LaravelRoles\Models\Role::class
        'permission'    => env('ROLES_DEFAULT_PERMISSION_MODEL', \App\Models\Permission::class), // jeremykenedy\LaravelRoles\Models\Permission::class
