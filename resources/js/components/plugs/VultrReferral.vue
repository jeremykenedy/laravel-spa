<template>
  <div>
    <div v-if="VULTR_REFERRAL_ENABLED"
      ...
      <a :href="VULTR_REFERRAL_LINK" target="_blank" style="min-height: 200px; min-width: 300px"
        @click="track('User Clicked Vultr Referral Link')">
        <img :src="referralImage" alt="Vultr Hosting Services" class="ml-auto mr-auto mb-4 rounded-t"
