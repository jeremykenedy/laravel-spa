<template>
  <AppButton v-if="bmcEnabled" text="Buy me a coffee" type="button"
    ...
    <template #text>
      <svg width="25" height="22" viewBox="0 0 25 22" version="1.1" xmlns="http://www.w3.org/2000/svg"
