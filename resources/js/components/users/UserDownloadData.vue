<template>
    <AppButton primary text="Process Download" :loading="loading" class="inline-flex items-center justify-center px-5 py-3"
        :icon="loading ? 'fa fa-circle-notch fa-spin' : 'fa fa-download'" @click="triggerUserDataDownload()" />
</template>
