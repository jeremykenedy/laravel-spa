<template>
    <div>
        ...
        <textarea :id="setting.key" type="text" :name="setting.key" :placeholder="setting.name"
            ...
            :value="setting.val" :rows="rows" :cols="cols" @blur="updateSetting($event.target.value)"
