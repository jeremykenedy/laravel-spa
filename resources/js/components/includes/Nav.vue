            ...
            <div
                ...
                <div v-if="authenticated" class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                    ...
                    <span v-if="authenticated && user"
                        v-tippy="'Switch Theme to ' + (isDarkTheme ? 'Light' : 'Dark') + ' Mode'" class="mr-4" :class="loading ? 'default disabled cursor-pointer' : 'cursor-pointer'
                    ...
                    <div v-if="authenticated && user" ref="dropMenu" class="relative">
                        ...
                        <div v-show="drop" @click="drop = !drop"
                            ...
                            <div class="flex cursor-pointer items-center rounded-b hover:rounded-b p-4 pr-10 pl-8 text-gray-700 hover:bg-slate-600 hover:text-white"
                ...
                <div v-if="!authenticated" class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                    ...
                    <router-link v-slot="{ isActive }" :to="{ name: 'auth.register' }" @click="closeDrop">
                        <AppButton primary text="Sign Up" class="ml-8" :class="[isActive && 'opacity-60']" />
                    </router-link>
                </div>
                ...
                <transition enter-active-class="duration-200 ease-out" enter-from-class="opacity-0 scale-95"
                    ...
                    <PopoverPanel v-show="drop" v-slot="{ close }" focus
                            ...
                            <div class="px-5 pt-5 pb-6">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <router-link v-slot="{ isActive }" :to="{ name: 'home' }" @click="close">
                            ...
                            <div class="space-y-6 py-6 px-5">
                                <div class="">
                                    ...
                                    <div class="mr-2 mb-7 w-full float-left"
                                        ...
                                        @click="toggleDarkMode()">
                                        <Switch :default-checked="isDarkTheme"
                                            :class="isDarkTheme ? 'bg-gray-500' : 'bg-gray-400'"
                                        ...
                                        <div class="ml-2 text-base font-medium float-left text-gray-500 hover:text-gray-900 dark:hover:text-gray-200"
                                ...
                                <div v-if="!authenticated">
                                    <router-link v-slot="{ isActive }" :to="{ name: 'auth.register' }">
                                        <AppButton primary text="Sign up"
                                            ...
                                            :class="[isActive && 'opacity-60']" @click="close" />
                                    </router-link>
                                ...
                                <div v-if="authenticated && user">
                                    <AppButton v-if="authenticated && user && isImpersonating"
                                        v-tippy="'Return to your account'" type="button" icon="fa-solid fa-user-secret"
                                        warning class="flex w-full items-center justify-center px-4 py-4 mb-5"
                                        text-after="Leave Impersonating" @click="leaveImpersonatingUser"
                                        @click.prevent="leaveImpersonatingUser(), closeDrop()" />
