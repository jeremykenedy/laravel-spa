<template>
    <div class="flex flex-wrap justify-around">
        <span v-if="logins.facebook == 1" v-tippy="'Facebook'"
        ...
        <span v-if="logins.twitter == 1" v-tippy="'Twitter'"
        ...
        <span v-if="logins.instagram == 1" v-tippy="'Instagram'"
        ...
        <span v-if="logins.github == 1" v-tippy="'GitHub'"
        ...
        <span v-if="logins.youtube == 1" v-tippy="'YouTube'"
        ...
        <span v-if="logins.google == 1" v-tippy="'Google'"
        ...
        <span v-if="logins.linkedin == 1" v-tippy="'LinkedIn'"
        ...
        <span v-if="logins.twitch == 1" v-tippy="'Twitch'"
        ...
        <span v-if="logins.apple == 1" v-tippy="'Apple'"
        ...
        <span v-if="logins.microsoft == 1" v-tippy="'Microsoft'"
        ...
        <span v-if="logins.tiktok == 1" v-tippy="'TikTok'"
        ...
        <span v-if="logins.zoho == 1" v-tippy="'Zoho'"
        ...
        <span v-if="logins.stackexchange == 1" v-tippy="'StackExchange'"
        ...
        <span v-if="logins.gitlab == 1" v-tippy="'GitLab'"
        ...
        <span v-if="logins.reddit == 1" v-tippy="'GitLab'"
        ...
        <span v-if="logins.snapchat == 1" v-tippy="'Snapchat'"
        ...
        <span v-if="logins.meetup == 1" v-tippy="'Meetup'"
        ...
        <span v-if="logins.atlassian == 1" v-tippy="'Atlassian'"
