<template>
    <label for="fileInput"
        ...
        <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 bg-white dark:bg-gray-900"
            ...
            <div class="text-center">
                ...
                <div class="mt-4 flex text-sm/6 text-gray-600">
                    ...
                    <input type="file" name="file" id="fileInput" class="hidden-input sr-only" @change="onChange"
                        ref="refFiles" accept=".gif,.webp,.jpg,.jpeg,.png" />
