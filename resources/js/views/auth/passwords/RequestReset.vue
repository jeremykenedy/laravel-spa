          ...
          <div class="p-4">
            ...
            <form class="mx-auto w-full md:w-10/12 md:p-4" @submit.prevent="submitForgotPassword">
              <div class="my-1 w-full py-2 sm:flex sm:items-center sm:justify-between">
                <label for="email" class="w-4/12 dark:text-gray-200" :class="{
                  'text-red-500':
                ...
                <div class="sm:mt-0 sm:w-8/12">
                  <input v-model="forgotForm.email" type="email" id="email" name="email" autocomplete="username" :class="{
                    'border-red-500':
                      validationErrors?.email,
                  }" :disabled="processing.value"
                    class="mt-3 w-full rounded border border-gray-300 bg-white p-2 focus:outline-none" autofocus />
