      ...
      <div class="text-gray-900 dark:text-gray-100 md:flex md:flex-row md:items-start md:justify-between">
        ...
        <div class="none w-full rounded-md border dark:border-gray-500 p-4">
          <div class="flex flex-wrap">
            ...
            >
              <figure class="m-2 flex flex-col justify-left p-6 text-left rounded-lg shadow dark:shadow-none bg-gray-100 text-gray-600 dark:border-slate-900 dark:bg-slate-900 hover:shadow-sm hover:bg-gray-200 dark:hover:bg-slate-700">
