        ...
        <div class="w-auto rounded border dark:border-gray-600 m-5">
          ...
          <div class="mx-4 mt-4">
            <div class="mt-2 grid grid-cols-1">
              <input v-model="searchTerm" type="text" name="search" id="search" class="col-start-1 row-start-1 block w-full rounded-md bg-white py-1.5 pl-10 pr-3 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:pl-9 sm:text-sm/6 dark:bg-gray-900 dark:outline-gray-600 dark:text-gray-200" placeholder="Search activities..." @input="applyFilters">
          ...
          <div class="rounded bg-white mx-4 my-2 dark:bg-slate-800 dark:text-gray-300">
            ...
            <div v-if="activities?.data?.length == 0" class="text-center p-6 my-6  bg-gray-200 dark:bg-gray-900 rounded">
              {{ $t('no_records_found') }}
            </div>
          </div>
