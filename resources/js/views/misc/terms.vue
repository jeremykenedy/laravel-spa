          ...
          <div>
            <div class="mb-10">
              <h3 class="mb-4 flex items-center text-lg font-medium text-gray-900 dark:text-white">
                <svg class="mr-2 h-5 w-5 flex-shrink-0 text-gray-500 dark:text-gray-400" fill="currentColor"
            ...
            <div class="mb-10">
              ...
              <p class="text-gray-500 dark:text-gray-400">
                Feel free to
                <a href="#" class="font-medium text-primary-600 underline hover:no-underline dark:text-primary-500"
            ...
            <div class="mb-10">
              ...
              <p class="text-gray-500 dark:text-gray-400">
                ...
                <Link to="/license"
                  class="font-medium text-primary-600 underline hover:no-underline dark:text-primary-500">reading the
                license</Link>.
              </p>
            </div>
          </div>
          <div>
            <div class="mb-10">
              ...
              <p class="text-gray-500 dark:text-gray-400">
                ...
                <a href="#"
                  class="font-medium text-primary-600 underline hover:no-underline dark:text-primary-500">roadmap</a>
            ...
            <div class="mb-10">
              ...
              <p class="text-gray-500 dark:text-gray-400">
                The
                <a href="#" class="font-medium text-primary-600 underline hover:no-underline dark:text-primary-500">free
                  version</a>
